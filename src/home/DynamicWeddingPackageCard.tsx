...
import type { WeddingPackageRow, WeddingPackageSection } from "@/blog/weddingPackages";
...
function SectionBody({ s }: { s: WeddingPackageSection }) {
  return (
    <>
...
export function DynamicWeddingPackageCard({ pkg }: Props) {
