...
export function WeddingJuniorPackageCard() {
  ...
  return (
    <PackagePricingCardShell
      leadSummary={{
        ...
        packageName: "Paket Wedding Junior",
      ...
      header={
        <>
          ...
          <PackageCardPricePromoWrap
            ...
            footNote={
              <PackagePromoMarquee text="Cocok untuk acara di Rumah & Restaurant" />
            }
          />
        </>
      }
          ...
          <AccordionItem value="wj-photo" className="border-0">
            ...
            <AccordionContent className="rounded-b-lg border border-t-0 border-border bg-[oklch(0.97_0.01_90)] px-3 pb-4 pt-3 text-[0.8125rem] md:px-4 leading-relaxed data-[state=closed]:border-0">
              ...
              <ul className="mt-3 list-disc space-y-1.5 pl-4 text-foreground/90">
                ...
                <li>
                  <strong>Full Sesi Pemotretan (Sampai Selesai Acara)</strong>
                </li>
              </ul>
            </AccordionContent>
          </AccordionItem>
      ...
      cta={<PackageConsultLeadForm packageLabel="Paket Wedding Junior" />}
    />
  );
}
