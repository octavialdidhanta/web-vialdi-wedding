...
export function ContactPage() {
  ...
  async function onNext() {
    ...
    try {
      ...
      setErrorMessage(e?.message ?? "Terjadi kesalahan. Coba lagi.");
    } finally {
      setSubmitting(false);
    }
  }
        ...
        <div className="mx-auto w-full max-w-2xl">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Cukup 3 langkah singkat (±30 detik). Informasi ini membantu kami memberi rekomendasi awal yang
              relevan tanpa komitmen.
            </p>
          </div>
          ...
          <Card className="border-border/60">
                ...
                <div className="space-y-2">
                  ...
                  {touched.phone && !phoneOk ? (
                    <div className="text-xs font-medium text-destructive">
                      Nomor telepon tidak valid. Gunakan 9–15 digit (contoh: 0812xxxxxxx atau +62812xxxxxxx).
                    </div>
                  ) : null}
                </div>
                <div className="space-y-2">
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <Button onClick={onNext} disabled={!canNext}>
                {step === 3 ? (submitting ? "Mengirim..." : "Kirim") : submitting ? "Menyimpan..." : "Lanjut"}
              </Button>
            </div>
            </CardContent>
          </Card>
