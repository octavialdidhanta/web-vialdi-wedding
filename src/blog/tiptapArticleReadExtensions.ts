/**
 * Skema sama dengan `admin/lib/documentExtensions` untuk `generateHTML` di artikel publik.
 * File terpisah agar bundler tidak menarik modul admin/editor ke chunk beranda.
 */
...
export const tiptapArticleReadExtensions = [
