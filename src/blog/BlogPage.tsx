          ...
          {isLoading ? (
            <div id="pilihan-editor" aria-busy="true" aria-label="Memuat sorotan">
              ...
              <div className="flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm md:flex-row">
                <Skeleton className="aspect-square w-full shrink-0 rounded-none md:w-48 md:shrink-0" />
            ...
            {isLoading ? (
              <div className="flex flex-col gap-4" aria-busy="true" aria-label="Memuat daftar artikel">
                {Array.from({ length: 5 }).map((_, i) => (
                  ...
                  >
                    <Skeleton className="aspect-square w-full shrink-0 rounded-none md:w-44 md:shrink-0" />
                    <div className="min-w-0 flex-1 space-y-2 p-4 md:p-3 md:py-4 md:pl-3 md:pr-4">
                      <Skeleton className="h-3 w-24" />
