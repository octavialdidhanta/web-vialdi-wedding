-- Re-apply admin_analytics_summary: baris acquisition_top_campaigns menyertakan meta_* (satu tabel dashboard).
-- Sama isi dengan 20260420120600 terbaru; jalankan setelah 20260420120600 bila DB sudah pernah di-migrate versi lama.
